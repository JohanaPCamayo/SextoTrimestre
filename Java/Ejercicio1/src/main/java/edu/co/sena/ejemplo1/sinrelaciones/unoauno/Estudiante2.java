 ...
 */
@Entity
@Table(name = "estudi2", indexes = {@Index(name = "pruebaIndice", columnList="NOMBREESTUDIANTE,IDESTUDIANTE,TIPODOCUMENTO, NUMERODOCUMENTO,CORREOELECTRONICO,TELEFONO,DIRECCION")})
